...
export default function Answer({ role, title, description, user, onRemove, onSee } :
    { role: Role, title: string, description: string, user: string, onRemove:() => void, onSee:() => void }) {
    return (
