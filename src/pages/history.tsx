    ...
    return (
        <div className="w-full bg-[#2F5597]">
            <div className="container mx-auto p-4 ">
                ...
                <div className="md:flex md:space-x-8 mb-8 text-white">
                    {/* First Column */}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                    ...
                    <div className="flex justify-center">
                        <Image src="/his_one.png" alt="Image 1" width={300} height={250} className="w-96 rounded-lg shadow-lg" />
                    </div>
                    {/* Image 2 */}
                    <div className="flex justify-center">
                        <Image src="/his_two.png" alt="Image 2" width={300} height={250} className="w-96 rounded-lg shadow-lg" />
                    </div>
                    {/* Image 3 */}
                    <div className="flex justify-center">
                        <Image src="/his_three.png" alt="Image 3" width={300} height={250} className="w-96 rounded-lg shadow-lg" />
                    </div>
                </div>
            </div>
                ...
                <div className="flex flex-col md:flex-row items-start mb-6">
                    ...
                    <div className="md:w-1/3 flex flex-col items-center">
                        <div className="p-4 mb-4 w-full">
                            ...
                            <Image src="/wave.png" alt="Image" width={157} height={200} className="h-50 w-96 mr-2 mb-7 hidden md:block" />
                            {/* Founder image */}
                            <Image src="/founder.png" alt="Founder Image" width={385} height={383} className="mt-4" />
                            {/* Decorative wave image */}
                            <Image src="/wave.png" alt="Image" width={157} height={200} className="h-50 w-96 mr-2 mt-7 hidden md:block" />
                        </div>
                    </div>
                </div>
